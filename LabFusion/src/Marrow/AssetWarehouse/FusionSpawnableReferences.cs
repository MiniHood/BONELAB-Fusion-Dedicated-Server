...
public static class FusionSpawnableReferences
{
    public static readonly SpawnableCrateReference BitMartReference = new("Lakatrazz.FusionContent.Spawnable.BitMart");
